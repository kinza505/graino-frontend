  ...
  return (
    ...
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center font-sans">
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          {/* HEADING: Fully Responsive for all screens */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-4 md:mb-6 leading-[1.1] tracking-tight">
            Perfect Dough Maker
          </h1>
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 mb-8 md:mb-10 max-w-xs sm:max-w-md md:max-w-2xl mx-auto leading-relaxed">
            Crafted for perfection, our dough maker delivers consistent mixing
